...
const Hero = () => {
  ...
  const handleGetNFT = () => {
    const section = document.getElementById('section_nft');
    if (section) {
  ...
  return (
    <div className="z-10 mt-4 bg-[url('assets/home/bg-hero.svg')] w-full bg-cover bg-no-repeat flex flex-col items-center justify-center gap-4 md:gap-7 py-[200px] lg:py-[200px] text-center">
      ...
      className='w-auto bg-gradient-to-r from-[#3AE071] to-[#006F25] px-8 py-3 md:py-5 rounded-full text-white font-montserrat text-[14px] md:text-[18px] leading-[22px] cursor-pointer'>Get NFT</button>
